# Pseudo-log transformations

```{r pl-setup, include=FALSE}
...
```{r pl02, warning=FALSE, message=FALSE}
...
```{r pl03, warning=FALSE, message=FALSE}
...
```{r pl04, warning=FALSE, message=FALSE}
x <- x*10
...
```{r pl05, warning=FALSE, message=FALSE}
...
```{r pl06, warning=FALSE, message=FALSE}
...
```{r pl07, warning=FALSE, message=FALSE}
x<-sort(exp(rnorm(1000)+3))
...
```{r pl08, warning=FALSE, message=FALSE}
x1 <- scale(rnorm(1000))
x2 <- scale(rexp(1000))
...
```{r pl09, warning=FALSE, message=FALSE}
x<-sort(rnorm(1000))
