...
unique.variables <- unique.variables[3:length(unique.variables)]

#variables 
#unique.variables
#b_bact %>% glimpse()

#TODO:: track down issue
...
#    print(ida_plot_univar_orig_vs_trans(b_bact, unique.variables[j], sigma=sigma_values[j], n_bars=100))
#  }
# }
...
#save(list=c("b_bact", "bact_variables", "sigma_values", "bact_transformed"), 
#     file=here::here("data", "a_bact02_c.rda"))
```
